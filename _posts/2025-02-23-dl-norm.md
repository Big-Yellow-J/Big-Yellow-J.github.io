...
<img src="https://s2.loli.net/2025/06/21/SiEXaUzb9e6hAKf.webp" alt="image" width="789" height="232" loading="lazy" decoding="async" />
...
<img src="https://s2.loli.net/2025/11/11/fxepYTQ532y6Cc8.webp" alt="image" width="693" height="286" loading="lazy" decoding="async" />
**代码**：（`pytorch`）
```python
import torch
