...
- cv-backbone
- 卷积网络
description: 本文介绍ConvNeXt及其两个版本。ConvNeXt v1对ResNet进行宏观设计调整、采用逆瓶颈结构、更换大卷积核并优化微观设计来改进；ConvNeXt
  v2引入Masked Autoencoder和Global Response Normalization，前者随机移除patches还原，后者解决特征图问题，证明卷积借鉴Vit操作也能有好效果。
---
