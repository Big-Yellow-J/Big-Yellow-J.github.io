...
<center>A Unified Approach to Interpreting Model Predictions</center>
...
1、[机器学习可解释性--LIME](https://hjezero.github.io/posts/cd6f0230/)
2、[机器学习可解释性--SHAP](https://hjezero.github.io/posts/5bf8429/)
# 机器学习可解释性--SHAP
[TOC]
## 1、Shapley Value
...
<div align="center"><img src="https://s2.loli.net/2023/06/07/cgknwhxlI9uJT4H.png" alt="202306071608311" style="zoom:80%;"/></div>

>⼀套 50 平⽅⽶的公寓，附近有公园以及禁⽌猫⼊内，预计价格为 300,000 欧元
>那么1、公寓面积；2、公寓楼层；3、养猫？4、公园？这4个特征对**预测价格**300000欧元的**贡献**是怎么样的呢？
...
>计算边际贡献：
><div align="center"><img src="https://pica.zhimg.com/450be1b5a2d5196399f6665086a728d2_r.jpg?source=1940ef5c" alt="202306071608311" style="zoom:80%;"/></div>
>
>根据公式1得到：
>1的shapley value：
...
> 
> <img src="https://s2.loli.net/2023/06/08/LFq8k1WHQsghB4P.png" alt="202306081444642" style="zoom:60%;"/>
> 
> > 就是上面列子中提及到的计算方法
...
>
> <img src="https://s2.loli.net/2023/06/08/g3nWKHrlfB5Z79T.png" alt="202306082023949" style="zoom:60%;"/>
