...
![](https://files.seeusercontent.com/2026/05/07/Bdp0/example-time-1.webp)
...
```
![](https://files.seeusercontent.com/2026/05/07/Z8uj/example-time-4.webp)
**时间 4**：请求 0 完成并释放。块 2、3 和 4 按反向顺序添加到空闲队列（但块 2 和 3 仍被缓存）。块 0 和 1 未添加到空闲队列，因为它们正在被请求 1 使用
![](https://files.seeusercontent.com/2026/05/07/cxT9/example-time-5.webp)
**时间 5**：请求 1 完成并释放。
![](https://files.seeusercontent.com/2026/05/07/jWa5/example-time-6.webp)
