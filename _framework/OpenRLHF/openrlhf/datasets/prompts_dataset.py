...
if __name__ == '__main__':
    ...
    class FakeStrategy:
        ...
        args = Args()
    dataset = [
        {"input": "Hello, how are you?", "label": "I'm doing well, thank you!"},
        {"input": "What's the weather like today?", "label": "It's sunny and warm."},
        {"input": "Tell me a joke!", "label": "Why don’t skeletons fight each other? They don’t have the guts!"}
    ]    
    tokenizer = FakeTokenizer()
    strategy = FakeStrategy()
    prompt_dataset = PromptDataset(dataset, tokenizer, strategy)
