...
if __name__ == '__main__':
    import time
    from code.Python.ModelArch.Attention.MultiHeadAttention import MultiHeadAttention
    from code.Python.ModelArch.Attention.QwenWindowAttention import QwenWindowAttention
